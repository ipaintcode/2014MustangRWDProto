...
<head>
  ...
  <script type="text/javascript" src="assets/scripts/lib/jquery.translate3d.js">
</script>
  <script type="text/javascript" src="assets/scripts/lib/jquery.ui.widget.js">
</script>
  <script type="text/javascript" src="assets/scripts/lib/jquery.event.drag.js">
</script><!-- carousel -->

  <script type="text/javascript" src="assets/scripts/jquery.rs.carousel.js">
</script>
  <script type="text/javascript" src="assets/scripts/jquery.rs.carousel-autoscroll.js">
</script>
  <script type="text/javascript" src="assets/scripts/jquery.rs.carousel-continuous.js">
</script>
  <script type="text/javascript" src="assets/scripts/jquery.rs.carousel-touch.js">
</script>
  <style>
        ...
        <div class="block">
          ...
          <ul class="nav">
            ...
            <li id="vehicles" class="not-active">
              <a href="#nav-vehicles">Autoveicoli</a>
            ...
            <li class="nav-top not-active">
              <a href="index.php">Acquisti</a>
            </li>

            <li class="nav-top not-active">
              <a href="index.php">Proprietari</a>
            </li>

            <li class="nav-search not-active">
              <a href="index.php">Cerca</a>
            </li>
          ...
          <div class="grid-row">
            <section class="slider">
              <div class="flexslider">
                <ul class="slides">
                  <li><img src="assets/images/billboard/ih1-1400.jpg"></li>

<!--                   <li><img src="assets/images/billboard/ih2-1400.jpg"></li>

                  <li><img src="assets/images/billboard/ih3-1400.jpg"></li>

                  <li><img src="assets/images/billboard/ih4-1400.jpg"></li> -->
                </ul>
              </div>
            </section>
          </div>
            ...
            <div class="column-alt solid-pagination container-social-stories">
              <div class="content-block">
                <div class="content-block-head">
                  <h2 class="h1">Ford<span class="h1-strong">Sociale</span> <span class="h3">&ndash; All'Interno.</span></h2>
                </div>
				<style>
                ...
                <div class="content-block-body">
                  <p class="body-copy">Storie impressionante. Info Insider. Nuove idee. Quando si tratta di Ford, questo è il posto giusto per imparare, condividere e chattare con Ford addetti ai lavori ed i tuoi compagni di proprietari di Ford. <span class="hide-me-now">Ottenere lo scoop sugli sviluppi Ford. Informazioni sulle prossime vetture o di nuove tecnologie così eccitante sembra fantascienza. Condividere un'idea con i nostri ingegneri o progettisti. Racconta la tua storia preferita Ford a gente che può veramente apprezzare. La conversazione sta già accadendo qui a</span> <a href="index.php" title="Ford Social">Ford sociale</a>. Quindi saltare e iniziare.</p>
                </div>
              </div>
              ...
              <ul class="clearfix social-stories">
                ...
                <li>
                  <div class="media-object story is-next">
                    ...
                    <div class="media-content">
                      <h3 class="h4 h4-strong">Come di un grande Fan Truck sei?</h3>
                ...
                <li>
                  <div class="media-object story">
                    ...
                    <div class="media-content">
                      <h3 class="h4 h4-strong">Sei Usa i Social Media? Ford fa!</h3>
                ...
                <li>
                  <div class="media-object story">
                    ...
                    <div class="media-content">
                      <h3 class="h4 h4-strong">Primo sguardo al Fresh Nuova Ford Fiesta</h3>
                ...
                <li>
                  <div class="media-object story">
                    ...
                    <div class="media-content">
                      <h3 class="h4 h4-strong">La piccola locomotiva che poteva: Racing un EcoBoost</h3>
          ...
          <div class="grid-row background-secondary new-featured">
            <div class="column-alt">
              <div class="videos-title">
                <h3 class="h2 h2-alt">Cosa sta succedendo a <span class="h2-strong">Ford.com?</span></h3>
              </div>

              <div id="container-cars">
                <div id="rs-carousel" class="rs-carousel module">
                  <ul class="rs-carousel-runner">
                    <li class="rs-carousel-item play-btn"><img src="assets/images/conversation-1.png"> <!-- <h4>GT Premium Convertible </h4>
                    ...
                    <li class="rs-carousel-item"><img src="assets/images/conversation-2.png"> <!-- <h4>GT Premium Convertible </h4>
                                            <h5><em><sup>$</sup>42,000</em>Starting MSRP<span class="footnote">1</span></h5>
                                            <h6>MPG City/Hwy <span class="em">26/36</span><span class="footnote">2</span></h6> --></li>

                    <li class="rs-carousel-item"><img src="assets/images/conversation-3.png"> <!-- <h4>GT Premium Convertible </h4>
                                            <h5><em><sup>$</sup>42,000</em>Starting MSRP<span class="footnote">1</span></h5>
                                            <h6>MPG City/Hwy <span class="em">26/36</span><span class="footnote">2</span></h6> --></li>
            ...
            <div class="column-alt">
              <div class="map-object map-object-bottom">
                <div class="map-header">
                  <h2 class="h2"><span class="h2-strong">Proprio fiducia Ford</span> per postale <span class="h2-alt2">48126.</span></h2>

                  <div class="map-find">
                    <div class="h4">
                      <a href="index.php">Tutti Sedi</a> oppure <a href="index.php">La tua posizione corrente</a>
                    </div>
                  </div>
                </div>
                  ...
                  <ul>
                    <li>
                      ...
                      <div class="address-dealer a">
                        <a class="address-dealer-name" href="index.php">Rs Automobili</a> <span class="mileage">1.81 miles away</span>

                        <div class="body-copy">
                          Via Brianza, 5<br>
                          30034 Di Mira, Italy<br>
                          041 099 0040
                    ...
                    <li>
                      ...
                      <div class="address-dealer">
                        <a class="address-dealer-name" href="index.php">Fairlane Ford</a> <span class="mileage">5.12 miles away</span>
                ...
                <div class="map-content">
                  ...
                  </div><img src="assets/images/map_italy.png" alt="Map">
          ...
          <div class="grid-row">
            <div class="footer">
              ...
              <div class="footer-additional">
                ...
                <a href="#" class="btn-additional">Visualizza informazioni</a>
                <a href="regions.php" class="btn-additional btn-region">Scegli il tuo paese o regione.</a>
              </div>
...
<audio style="visibility: hidden;">
   <source src="assets/mp3/Yolanda_Be_Cool_DCUP_We_No_Speak_AmericanoHQ.mp3" type='audio/mpeg; codecs="mp3"'>
</audio>
-->
<script src="assets/scripts/jquery.transit.js">
...
*/
		...
		audioElement.setAttribute('src', 'assets/mp3/Yolanda_Be_Cool_DCUP_We_No_Speak_AmericanoHQ.mp3');
		audioElement.load()
